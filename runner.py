...
def main():
    ...
    try:
        ...
        process = execute_command_using_popen(f"behavex {Fc.features} -c {Fc.conf_behavex} --parallel-processes 2 --parallel-delay 1000 --parallel-scheme feature --show-progress-bar -t=@QA-5,@QA-4")
        while True:
